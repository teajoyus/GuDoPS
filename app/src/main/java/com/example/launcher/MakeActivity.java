...
public class MakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.make_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MakeActivity.this, IsportActivity.class);
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(MakeActivity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    private void showTimePickerDialog() {
        Calendar c = Calendar.getInstance();
        new TimePickerDialog(MakeActivity.this, new TimePickerDialog.OnTimeSetListener() {
